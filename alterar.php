...
<?php
        ...
        //Realizando a consulta para alteração dos dados
        if(isset($_GET["id"])){
            $id=$_GET["id"];
        }else{
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
            <div class="container">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                         ...
                         <li class="active s"><a href="alterar.php">Alterar Tarefa</a></li>
        ...
        <div class="jumbotron fundo">
            <div class="container fundo">
                <h2 class="s">Edição de Tarefas</h2>
                <p class="s"></p>
            </div>
        </div>        
        <div class="container">
        <div class="col-md-12">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title h1">Editar Tarefa</h3>
                </div>
                <br >
                <form name="buscar" class="form-horizontal" action="<?=$_SERVER["PHP_SELF"];?>" method="post">
                    <fieldset>
                        <div class="form-group">
                ...
                <form name="alterar" class="form-horizontal" action="dao/atualizar_tarefa.php" method="post">
                     <fieldset>
                         <div class="form-group">
                            <label for="inputNome" class="col-lg-2 control-label">Nome da Tarefa</label>
                            <div class="col-lg-9">
                                <input type="text" class="form-control" id="inputNome" name="nome" placeholder="Informe o nome da nova tarefa" value="<?=$rs["nome"];?>" required="">
                            </div>
                        </div>
                        <div class="form-group">
                           <label for="descricao" class="col-lg-2 control-label">Descrição:</label>
                        <div class="col-lg-9">
                               <textarea class="form-control" rows="2" id="descricao" name="descricao" placeholder="Informe a nova descrição"><?=$rs["descricao"];?></textarea>
                        </div>
                      </div> 
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                 ...
                                 <?php
                                 switch($rs["prioridade"]){
                                      case 1:
                                      echo " <option selected>1</option>";
                                      echo " <option>2</option>";
                                      echo " <option active>3</option>";
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <input type="text" class="form-control" id="inputNomeUsuario" name="usuario" placeholder="Informe o novo nome do usuário" value="<?=$rs["usuario"];?>" required="">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="col-lg-6 col-lg-offset-2">
                              <button type="submit" name="operacao" class="btn btn-success" value="atualizar">Atualizar</button>                                  
                            </div>
                        </div>
